  ...
  <body class="hold-transition skin-blue layout-top-nav">
      ...
      <div class="content-wrapper">
        ...
        <section class="content container-fluid">
          ...
          <div class="row">
            ...
            <form:form enctype="multipart/form-data" modelAttribute="referenceUser" 
            	id="theForm" action="${pageContext.servletContext.contextPath}/user" method="POST" role="form">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <form:input type="email" class="form-control" id="name" name="name" path="name" placeholder="Usuário" disabled="true"/>
                </div>
	...
	$( "#formSubmit" ).click(function() {
		...
		*/
	    ...
	    $.ajax({
	        url: '${pageContext.servletContext.contextPath}/logs/${referenceUser.id}/20',
	        dataType: 'json',
