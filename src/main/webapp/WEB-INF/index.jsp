...
<!-- ************************************************************************** -->
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 "  >
                     ...
                     <div class="box box-danger" id="effisForm" style="display:none" >
                        ...
                        <div class="box-body" style="background-color:white">
                        	<img class="img-responsive" src="/olimpia/resources/img/copernicus.png"></img><br>
...
<!-- 	                        
 ...
 -->
                     ...
                     <div class="box box-primary" id="userCam" style="display:none" >
                        ...
                        <div class="box-body" style="background-color:white">
	                        <div  class="embed-responsive embed-responsive-4by3" >
	                        	<img style="width:100%" class="img-responsive" id="userCamImage" src="/olimpia/resources/img/static.gif"></img>
	                        </div>
                        </div>
                     </div>
...
<!-- ************************************************************************** -->
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 ">
                     <div class="box box-success">
			            <div class="mailbox-controls">
			              <a href="/olimpia/newUser" class="btn btn-default"><i class="fa fa-plus"></i></a>
			            </div>                     
